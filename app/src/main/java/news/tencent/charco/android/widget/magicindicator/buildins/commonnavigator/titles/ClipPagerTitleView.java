package news.tencent.charco.android.widget.magicindicator.buildins.commonnavigator.titles;
...
public class ClipPagerTitleView extends View implements IMeasurablePagerTitleView {
    ...
    private int selectSize = UIUtils.sp2px(16);
    private int unselectSize = UIUtils.sp2px(15);
